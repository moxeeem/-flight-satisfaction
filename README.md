...
Для применения классических моделей машинного обучения категориальные признаки были преобразованы в числовые значения с использованием метода `LabelEncoder()`. Кроме того, данные были стандартизованы с помощью метода `StandardScaler()`.
...
|  Метрика  |  Значение  |
|  :-------------:  | :---------: |
| accuracy | 0.8956242186104661 |
| recall  | 0.9134842642119667 |
| f1-score | 0.9095243993064157 |
